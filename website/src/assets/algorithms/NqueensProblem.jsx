...
//   const solveNQueensRecursively = (board, col, steps) => {
//     if (col >= N) {
//       setSolutionFound(true);
//       setSteps(steps);
//       setFinalSolution(board.map(row => [...row]));
//       return true;
//     }
...
//         if (solveNQueensRecursively(board, col + 1, steps)) {
//           return true;
//         }
...
//     const steps = [];
//     solveNQueensRecursively(initialBoard, 0, steps);
//     setSteps(steps);
//     setIsSolving(true);
//   };
...
//           disabled={isSolving}
//         >
//           {isSolving ? "Visualizing..." : "Start Visualization"}
//         </button>
//         <button
...
//       {solutionFound && (
//         <div className="mt-4 text-green-600 font-medium">Solution Found!</div>
//       )}
...
//       {finalSolution && (
//         <div className="mt-6">
//           <h2 className="text-xl font-bold mb-2 text-gray-800">Final Solution:</h2>
//           <div className="grid gap-1" style={{ gridTemplateColumns: `repeat(${N}, 1fr)` }}>
//             {finalSolution.map((row, i) =>
//               row.map((cell, j) => (
//                 <div
//                   key={`final-${i}-${j}`}
//                   className={`w-12 h-12 flex items-center justify-center border ${
