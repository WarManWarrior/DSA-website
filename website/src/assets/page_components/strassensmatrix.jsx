...
import StrassenMatrixVisualization from "../algorithms/Strassen_Matrix.jsx";
import data from "./data.json";

const Strassenmatrix = () => {
  ...
  const { title, sections, experiment } = data.Strassens_Matrix_Multiplication;
