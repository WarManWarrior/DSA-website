    ...
    return (
      ...
      >
        <img
          ...
          className={`absolute cursor-pointer -right-3 top-9 w-7 border-dark-purple border-2 rounded-full transition-transform ${
            !open && "rotate-180"
          }`}
        ...
        <div className="flex gap-x-4 items-center">
          ...
          />
          <h1
            className={`text-white origin-left font-medium text-xl duration-200 transition-transform ${
              !open && "scale-0"
            }`}
          >
            Linear Search
