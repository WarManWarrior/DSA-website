...
import LCSVisualizer from "../algorithms/LCS.jsx";
import data from "./data.json";

const Largestcommonsubs = () => {
  ...
  const { title, sections, experiment } = data.Largest_Common_Subsequence_using_Dynamic_Approach;
...
export default Largestcommonsubs;
