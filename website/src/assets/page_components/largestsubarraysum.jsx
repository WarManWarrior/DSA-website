...
import LargestSubarraySum from "../algorithms/largestsubarray.jsx";
...
const Largestsubarraysum = () => {
  ...
  const { title, sections, experiment } = data.Largest_Sub_ArraySum_using_Divide_and_Conquer_Approach;
